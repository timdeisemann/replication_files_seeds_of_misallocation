/*
	...
	Table 2: Effective nitrogen use, seed beliefs and DNA type
...
* If pdslasso is not found, install it
if _rc {
    display "pdslasso is not installed. Installing..."
    ssc install pdslasso
}
else {
    display "pdslasso is already installed."
}
...
quietly: reg nitrogen_kg_pha belief dna_95_95 belief_x_dna_95_95, robust cluster(ea_id) // seeds are improved 
eststo est1
estadd local basic_controls no
estadd local ext_controls no

quietly: reg nitrogen_kg_pha belief dna_95_95 belief_x_dna_95_95 $keycontrols, robust cluster(ea_id) // seeds are improved 
eststo est2
estadd local basic_controls yes
estadd local ext_controls no

quietly: reg nitrogen_kg_pha belief dna_95_95 belief_x_dna_95_95 $ext_controls, robust cluster(ea_id) // seeds are not improved
eststo est3
estadd local basic_controls yes
estadd local ext_controls yes

quietly: pdslasso nitrogen_kg_pha belief (dna_95_95 belief_x_dna_95_95 ///
i.dna_95_95#i.$categoricals i.dna_95_95#c.$numericals i.$categoricals ///
c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals ///
c.$numericals#i.$categoricals), rob cluster(ea_id) ///
aset(dna_95_95 belief_x_dna_95_95 $aset)

global selected_vars_model_4 dna_95_95 belief_x_dna_95_95 s7q04 s7q06 ///
s4q13b s4q14 s3q16 s5q02 s5q16 s2q04 s11b_ind_01 s7q22 s3q08_ha s1q03a ///
cs4q26 dist_road dist_market dist_popcenter manure_use gender

// For R-squared and other standard errors and test statistics
reg nitrogen_kg_pha belief $selected_vars_model_4, robust cluster(ea_id)
eststo est4
estadd local basic_controls yes
estadd local ext_controls yes

quietly: pdslasso nitrogen_kg_pha dna_95_95 (belief belief_x_dna_95_95 ///
i.belief#i.$categoricals i.belief#c.$numericals i.$categoricals ///
c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals ///
c.$numericals#i.$categoricals), rob cluster(ea_id) ///
aset(belief belief_x_dna_95_95 $aset)
...
gen saq01_13 = 1 if saq01 == 13
replace saq01_13 = 0 if saq01 != 13

gen sq7_3_x_saq01_13 = sq7_3*saq01_13

global selected_vars_model_5 belief belief_x_dna_95_95 s7q04 s7q06 s4q13b ///
s5q02 s2q04 s11b_ind_01 cs4q43 s3q08_ha s1q03a dist_road dist_market ///
dist_popcenter h2018_wetQstart manure_use gender sq7_3_x_saq01_13 ///
manure_use_x_saq01_3

quietly: reg nitrogen_kg_pha dna_95_95 $selected_vars_model_5, robust cluster(ea_id)
eststo est5
estadd local basic_controls yes
estadd local ext_controls yes

*_Export results________________________________________________________________
...
manure_use) b(2) se(2) stats(basic_controls ext_controls N ///
r2 , fmt(0 0 0 2))
