...
quietly: reg UREA_kg_pha belief dna_95_95 belief_x_dna_95_95, robust cluster(ea_id) // seeds are improved 

eststo est1
estadd local basic_controls no
estadd local ext_controls no

quietly: reg UREA_kg_pha belief dna_95_95 belief_x_dna_95_95 $keycontrols, robust cluster(ea_id) // seeds are improved 

eststo est2
estadd local basic_controls yes
estadd local ext_controls no

quietly: reg UREA_kg_pha belief dna_95_95 belief_x_dna_95_95 $ext_controls, robust cluster(ea_id) // seeds are not improved

eststo est3
estadd local basic_controls yes
estadd local ext_controls yes

quietly: pdslasso UREA_kg_pha belief (dna_95_95 belief_x_dna_95_95 i.dna_95_95#i.$categoricals i.dna_95_95#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals), rob cluster(ea_id) aset(dna_95_95 belief_x_dna_95_95 $aset)

global selected_vars_model_urea_belief dna_95_95 belief_x_dna_95_95 s7q04 s7q06 s4q14 ///
                                       s3q16 s5q02 s5q16 s2q04 s11b_ind_01 cs5q01_1 cs6q01 ///
                                       s7q22 s3q08_ha s1q03a cs4q26 dist_road dist_market ///
                                       dist_popcenter manure_use gender

quietly: reg UREA_kg_pha belief dna_95_95 belief_x_dna_95_95 $selected_vars_model_urea_belief, robust cluster(ea_id) // seeds are not improved

eststo est4
estadd local basic_controls yes
estadd local ext_controls yes

quietly: pdslasso UREA_kg_pha dna_95_95 (belief belief_x_dna_95_95 i.belief#i.$categoricals i.belief#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals), rob cluster(ea_id) aset(belief belief_x_dna_95_95 $aset)

global selected_vars_model_urea_dna belief belief_x_dna_95_95 s7q04 s7q06 s5q02 s2q04 ///
                                       s11b_ind_01 s7q20 s3q08_ha s1q03a dist_road ///
                                       dist_market dist_popcenter h2018_wetQstart ///
                                       manure_use saq01_15 gender sq7_3_x_saq01_15 ///
                                       sq7_4_x_saq01_7 manure_use_x_saq01_3   
...
quietly: reg UREA_kg_pha dna_95_95 $selected_vars_model_urea_dna, robust cluster(ea_id) // seeds are not improved
