/*
	...
	Table A6: Effective nitrogen use, seed beliefs and DNA type 
	(extensive margin)
...
*binary indicator for N>0 as outcome variable; N_use_bin
gen nitrogen_use_bin = 1 if nitrogen_kg_pha > 1
replace nitrogen_use_bin = 0 if nitrogen_kg_pha == 0

* Model 1

quietly: reg nitrogen_use_bin belief dna_95_95 belief_x_dna_95_95, robust cluster(ea_id) // seeds are improved 
...
* Model 2
quietly: reg nitrogen_use_bin belief dna_95_95 belief_x_dna_95_95 $keycontrols, robust cluster(ea_id) // seeds are improved 
...
* Model 3
quietly: reg nitrogen_use_bin belief dna_95_95 belief_x_dna_95_95 $ext_controls, robust cluster(ea_id) // seeds are not improved
...
quietly: pdslasso nitrogen_use_bin belief (dna_95_95 belief_x_dna_95_95 i.dna_95_95#i.$categoricals i.dna_95_95#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals), rob cluster(ea_id) aset(dna_95_95 belief_x_dna_95_95 $aset)

gen saq01_15 = 1 if saq01 == 15
replace saq01_15 = 0 if saq01 != 15

global selected_vars_model_4c dna_95_95 belief_x_dna_95_95 s7q04 s7q06 s7q11_1 s4q14 s3q16 s5q02 s5q16 s2q04 s11b_ind_01 s7q22 s3q08_ha s1q03a cs4q26 dist_road dist_market dist_popcenter cropshare manure_use saq01_15 gender

quietly: reg nitrogen_use_bin belief $selected_vars_model_4c, robust cluster(ea_id)
...
quietly: pdslasso nitrogen_use_bin dna_95_95 (belief belief_x_dna_95_95 i.belief#i.$categoricals i.belief#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals), rob cluster(ea_id) aset(belief belief_x_dna_95_95 $aset)
...
global selected_vars_model_5c belief belief_x_dna_95_95 s7q04 s7q06 s7q11_1 s4q14 s3q16 s5q02 s2q04 s11b_ind_01 cs5q01_1 s3q08_ha s1q03a dist_road dist_market dist_popcenter cropshare h2018_wetQstart manure_use gender manure_use_x_saq01_3

quietly: reg nitrogen_use_bin dna_95_95 $selected_vars_model_5c, robust cluster(ea_id)
