/*
	...
	Table A7: Effective phosphorus use, seed beliefs and DNA type
...
quietly: reg phosphorus_kg_pha belief dna_95_95 belief_x_dna_95_95, robust cluster(ea_id) // seeds are improved 

eststo est1
estadd local basic_controls no
estadd local ext_controls no

quietly: reg phosphorus_kg_pha belief dna_95_95 belief_x_dna_95_95 $keycontrols, robust cluster(ea_id) // seeds are improved 

eststo est2
estadd local basic_controls yes
estadd local ext_controls no

quietly: reg phosphorus_kg_pha belief dna_95_95 belief_x_dna_95_95 $ext_controls, robust cluster(ea_id) // seeds are not improved

eststo est3
estadd local basic_controls yes
estadd local ext_controls yes

quietly: pdslasso phosphorus_kg_pha belief (dna_95_95 belief_x_dna_95_95 i.dna_95_95#i.$categoricals i.dna_95_95#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals), rob cluster(ea_id) aset(dna_95_95 belief_x_dna_95_95 $aset)
...
global selected_vars_model_p_belief dna_95_95 belief_x_dna_95_95 1.dna_95_95#15.saq01 s7q04 s7q06 s4q14 s3q16 s5q02 s5q16 s2q04 s11b_ind_01 cs4q43 s7q14 s7q21 s7q22 s7q32b_1 s3q08_ha s1q03a cs4q26 dist_road dist_market dist_popcenter manure_use saq01_15 gender

quietly: reg phosphorus_kg_pha belief $selected_vars_model_p_belief, rob cluster(ea_id)
...
gen sq7_2 = 1 if sq7 == 2
replace sq7_2 = 0 if sq7 != 2
...
gen sq7_2_x_saq01_3 = sq7_2*saq01_3
...
quietly: pdslasso phosphorus_kg_pha dna_95_95 (belief belief_x_dna_95_95 i.belief#i.$categoricals i.belief#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals), rob cluster(ea_id) aset(belief belief_x_dna_95_95 $aset)

global selected_vars_model_p_dna dna_95_95 belief_x_dna_95_95 s7q04 s7q06 s4q13b ///
s3q16 s5q02 s2q04 s11b_ind_01 cs4q43 s7q14 s7q20 s3q08_ha s1q03a cs4q25 dist_road ///
                                       dist_market dist_popcenter h2018_wetQstart ///
                                       manure_use saq01_15 gender sq7_2_x_saq01_3 sq7_3_x_saq01_15 sq7_4_x_saq01_7 manure_use_x_saq01_3
									  

quietly: reg phosphorus_kg_pha belief $selected_vars_model_p_dna, rob cluster(ea_id)
...
replace label keep(belief dna_95_95 belief_x_dna_95_95 s7q04 s5q02 s3q08_ha ///
