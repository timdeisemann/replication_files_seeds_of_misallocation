/*
	...
	Table A5: Effective nitrogen use, seed beliefs and DNA type 
	(intensive margin)
...
*Table 2 using a binary indicator for N>0; N_use_bin
...
*Model 1
quietly: reg nitrogen_kg_pha belief dna_95_95 belief_x_dna_95_95 if nitrogen_kg_pha != 0, robust cluster(ea_id) // seeds are improved 
...
*Model 2
quietly: reg nitrogen_kg_pha belief dna_95_95 belief_x_dna_95_95 $keycontrols if nitrogen_kg_pha != 0, robust cluster(ea_id) // seeds are improved 
...
*Model 3
quietly: reg nitrogen_kg_pha belief dna_95_95 belief_x_dna_95_95 $ext_controls if nitrogen_kg_pha != 0, robust cluster(ea_id) // seeds are not improved
...
// incl. amelioration set

quietly: pdslasso nitrogen_kg_pha belief (dna_95_95 belief_x_dna_95_95 i.dna_95_95#i.$categoricals i.dna_95_95#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals) if nitrogen_kg_pha != 0, rob cluster(ea_id) aset(dna_95_95 belief_x_dna_95_95 $aset)

global selected_vars_model_4d dna_95_95 belief_x_dna_95_95 s7q04 s7q06 s5q02 s5q16 s2q04 s11b_ind_01 cs4q04__1 cs4q04__12 cs4q05__11 cs4q47 cs6q01 s3q08_ha s1q03a dist_road dist_market dist_popcenter manure_use gender

// For R-squared and other standard errors and test statistics

quietly: reg nitrogen_kg_pha belief $selected_vars_model_4d if nitrogen_kg_pha != 0, robust cluster(ea_id)
...
*Model 5 
quietly: pdslasso nitrogen_kg_pha dna_95_95 (belief belief_x_dna_95_95 i.belief#i.$categoricals i.belief#c.$numericals i.$categoricals c.$numericals i.$categoricals#i.$categoricals c.$numericals#c.$numericals c.$numericals#i.$categoricals) if nitrogen_kg_pha != 0, rob cluster(ea_id) aset(belief belief_x_dna_95_95 $aset)
...
global selected_vars_model_5e belief belief_x_dna_95_95 s7q04 s7q06 s5q02 s2q04 s11b_ind_01 s3q08_ha s1q03a dist_road dist_market dist_popcenter manure_use gender manure_use_x_saq01_3

quietly: reg nitrogen_kg_pha dna_95_95 $selected_vars_model_5e if nitrogen_kg_pha != 0, robust cluster(ea_id)
